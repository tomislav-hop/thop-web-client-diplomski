...
public class OrderItems implements Serializable {
	...
	private static final long serialVersionUID = -1424661906330791801L;
	...
	public OrderItems(int id_orderItems, int id_item, String deadline, double weight, String startTime, int delivery, int cool, int cut, int id_package, String additionalNotes, String deliveryTime, int id_order, int amount) {
		super();
